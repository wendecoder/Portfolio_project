...
```
> **Note** - If the specific version of a package isn't mentioned, then the default latest stable package will be installed. 
...
```
git clone https://github.com/wendecoder/Portfolio_project.git
